...
void create ()
{
	...
	set_short( "西方天帝 少昊");
	set_long(@CLONG
少昊生得濃眉大眼，胸寬腰挺，耳垂如珠，一張國字臉，非常有威儀。少昊是西方
諸神的統治者，管理著西方一萬二千里的地方，具有無上的權威。少昊曾在東方海
外建立一個國家，不知道經過了多少年，終於回到了這裡。
CLONG
	);
	set("race","god");
	set("gender","male");
...
int my_tactic()
{
    ...
    tell_room(environment(),sprintf("少昊對著%s狠狠的一擊！\n%s撤退了！\n",
