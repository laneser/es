...
void create()
{
        ...
        ::create();
        set_level(19);
        set_name( "flesheater", "肉食獸" );
        set_short( "肉食獸" );
        set_long(@C_LONG
哇咧....這傢伙到底是從哪裡來的怪物？它看起來像是人類，可是你百分之百
肯定它不是人！看來遇到它算是你倒楣了....。
C_LONG
                );
        set( "unit", "只" );
