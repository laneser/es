...
void cleanharmy(object *atk)
{
   ...
   for ( i=0;i<max;i++ ) 
     if ( living(atk[i]) ) { 
       tell_object(environment(atk[i]),sprintf("隨著戰爭結束，%s跟著離開。\n",
          atk[i]->query("c_name")));
...
忽然從遙遠的天際飄來一大團紅雲，空中頓時下起頃盆腥雨 ！

那雨下得人心沈悶，下得人心惶惶，更下得人們竟不知所措！
...
在那團紅雲上面一個栲栳大的人頭漸漸地浮現出來 .....

原來那是沈睡了三千多年之久的巨人族之神 － 蚩尤！
...
蚩尤登高一呼狂笑道：「 我親愛的巨人族同胞們，莫忘了三千年前巨人族的恥辱！」

蚩尤開始聚精會神吸取大地精華，並且向著這世間的所有強者挑戰！
...
黃帝神色慌張地喊道 : 「 唉呀，禹鼎裡的山精海怪被魑魅魎魍放出來了！
         
大地上殘存的勇者們快快放下手邊的工作和我一起趕走那些頭腦簡單四肢發
...
{
        int i;
        sendmsg("",1,"HIR","唉呀！你感到精氣神一點點地被蚩尤吸取了！\n");
      //  sendmsg("唉呀！你感到精氣神一點點地被蚩尤吸取了！\n",1,"HIR","");
...
「巫羅王」把手中的「巽靈珠」往蚩尤面上一丟，只聽到蚩尤一聲慘叫跟著

頭顱被黃帝砍了下來，瞬間身首異處！

隨著蚩尤的死亡，蚩尤大軍被擊潰，世間再度呈現和平！
