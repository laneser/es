...
不騰挪半步, 獨自靜坐於大海旁危巖之上, 達七晝夜之久, 而最後終於頓悟
...
void die()
{
   ...
   if( sizeof(flute ) > 1 ) {
        tell_room( environment(this_object()),
		"郭長老大叫一聲: 不! 我不能死! 你們想要我的玉簫？等下輩子吧!\n"
		"郭長老把玉簫插進自己的心臟並同時折斷玉簫!\n",
                this_object() );
        pipe->remove();
   }
   ::die();
