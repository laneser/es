...
void create()
{
	...
	set_short( "魔法師  帕多拉斯" );
	set_long(	"    魔法師帕多拉斯是魔法界的奇才，對於鑑定防具的魔法防禦，以及評估對手的\n"
"魔法防禦弱點有很深的研究。他正在把玩一個奇異的水晶球(orb)。\n"
	);
	set( "gender", "male" );
	set( "race", "human" );
	set( "alignment", -300 );
...
{
  tell_object(who,"帕多拉斯說:想要我用水晶球幫你鑑定防具的魔法防禦啊，除非我死否則休想。\n") ;
}

void ask_orb(object who)
{
  tell_object(who,"帕多拉斯說:說起這個水晶球，這個水晶球的特殊之處在於能鑑定防具的魔法防禦。\n帕多拉斯接著說：是我行走各地尋找材料，再施與特殊魔法制造而成，是我最寶貴的物品。\n") ;
}
