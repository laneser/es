...
string str1="大地精靈說：我的朋友、我必須要走了，假如須要我幫忙請再叫我。\n";
string str2="你見到地面裂了開來，大地精靈鑽了進去。\n";
string str3="HIM";
...
void create()
{
	...
	set( "tactic_func", "my_tactic" );
        set_c_verbs( ({"%s用腳往地上一蹬，地面一個隆起往%s撞去",
                       "%s用手向空中一揮，一陣風壓向%s直逼過去",
                       "%s把自己的身體當作武器，向%s衝了過去"}) );
}
...
int my_action(object me)
{
        ...
        tell_object(me,"大地精靈對你說：沒問題...我馬上來幫你擊退敵人!\n");
...
/*        if ( ! present(master,environment()) ) {
          tell_object(master,"大地精靈在你的身後大叫：臭小子，丟下我烙跑？？你給我記志 ...\n");
          tell_room(environment(),"大地精靈叫道 : 哎啊 ! "+master->query("c_name")+"這個臭小子丟下我跑了？我也要溜了 ..\n");
          if ( !wizardp(master) )
...
//	if ( (int)victim->query("hit_points") < dam ) return 0;
	  ...
	  tell_room( environment(this_object()),
	    set_color("\n大地精靈用它那強壯有力的四肢向敵人施展它的必殺技：十字鎖喉反扣!\n\n","HIR",master)
	    , this_object()
	  );
