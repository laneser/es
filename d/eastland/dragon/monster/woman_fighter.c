...
void create ()
{
        ...
        ::create();
        set_level(18);
        set_name( "woman fighter alisa", "龍人女戰士 亞里莎" );
        ...
        set("wealth/gold",100);
        set_long(@C_LONG
亞里莎是龍人族中最美麗的女性，雖然她是戰士群中的一員但是她的溫。
柔依舊沒被激烈的戰鬥所抹煞，她的柔情可以融化所有男人的心，她現今
是龍穴參觀者的接待人。
C_LONG
        );
...
{
   npc::init();
  tell_room(environment(this_object()),"歡迎光臨，此處是龍穴，低等級的玩家請離開此處\n");
}
