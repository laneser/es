...
void create()
{
	::create();
	set_level(4);
	set_name( "flower girl", "賣花女" );
        add ("id",({ "girl"}));
	set_short( "賣花女" );
	set_long(
		"她是一個看起來很清秀的賣花女，如果你有需要的話，可以向她買花，只要\n"
		"問她關於花(flower)的事，她就會很樂意地向你介紹她的花。\n"
	);
	set( "race", "elf" );
	set( "gender", "female" );
	set_inventory( ({
