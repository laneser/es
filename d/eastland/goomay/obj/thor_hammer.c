...
set("c_msg","你的雷神之錘「轟隆」的一聲巨響，發出一道金光，轟擊敵人的身體。\n\n");
set("c_enemy_msg","的雷神之錘「轟隆」的一聲巨響，發出一道金光，閃電般的轟擊你 !! \n\n");
set("c_fail_msg","你的雷神之錘「轟隆」一聲巨響發出一道金光，卻轟到你自己 ! \n\n");
set("c_fail_room_msg","的雷神之錘「轟隆」一聲巨響發出一道金光，卻轟到他自己 !\n\n");
