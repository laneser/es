...
void create()
{
    ::create();
    set_level(19);
    set_name("Emperor Yuishu","遙照");
    add("id",({"emperor","yuishu"}) );
    set_short("遙照天皇");
    set_long(@C_LONG
遙照天皇雖然年紀一大把了，可是卻還很有精神；只見他拿了把木刀，緩緩
的揮舞著，姿勢十分的優雅。咦～～！仔細一看，這刀法還真頗有大家風範
，只見他身形步伐均十分靈巧，攻守有度，一股王者的風範攏罩著他的全身
，你的直覺告訴你：他是位不平凡的人物。
C_LONG
            );
    set("unit","位");
...
int my_tactic()
{
    ...
    tell_room( environment(this_object()),
        "\n遙照大喝：秘～技，樹～雷～升～龍～霸!!一股強勁將所有人給送上天去了..\n\n");
       for( i=sizeof(victim)-1; i>=0; i--){
        ...
        "你看到他越飛越高，瞬間一閃，就變成天上的星星了!"
        , "天上的星星突然又一閃，哇，變成流星墜下來了!"); 
        }
