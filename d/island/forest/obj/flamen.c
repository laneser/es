...
int ask_canteen()
{
    ...
    if(8 (int)this_player()->query("alignment") < -5000 ){
       tell_object(this_player(),
       "鷲羽說：要東西？可以啊，不過我不給壞小孩禮物，你要乖乖的才行！\n"
        );   
       tell_room( environment(this_player()),
       "由於"+this_player()->query("c_name")+"不乖，所以鷲羽不給他禮物.....:P\n"
       ,this_player() );
       return 1;
    }
...
LONG
    ...
    write("鷲羽很不高興的說：你不聽話哦？小心出門被雷神公公劈哦！\n");
    this_player()->add("alignment",-2000);
    return 1;
    }
}
