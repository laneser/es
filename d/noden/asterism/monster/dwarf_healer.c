    ...
    for( i=0; i<sizeof(guard); i++ ) 
     ...
     if ( !guard[i]->query_attacker() ) {
      tell_room( environment(this_object()), 
        guard[i]->query("c_name")+"大喊: 夥伴們,讓我幫助你一起把敵人趕走吧!\n"
          ,guard[i]
      );
...
void relay_message(string class1 , string msg)
{
    ...
    if ( sscanf(msg,"矮人士兵說道：heal me please%s",a) != 1) {
...
void astrquest(object ob)
{
   ...
   write(
         "矮人醫官想了一下子後說道: 我好像曾給過這麼一個東西給歐瑞安長老,\n"
