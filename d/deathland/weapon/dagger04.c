...
void create()
{
    ...
    set("special_c_msg","說:讓我們把敵人的生命毀滅吧,我的主人.\n\n");
}
...
int evil_damage(object victim,int damage)
{
    ...
    if ( my_ali > vic_ali &&  my_ali > -400 ) {
      tell_object(holder,"這把邪惡的小刀發出邪惡的笑聲:我只服從邪惡的人.\n\n");
...
{
if (damage_num == 0)
return ("一把神秘而且奇怪的小刀,能夠很隱秘地刺入敵人的心臟而不被發覺，但是卻似乎失去了原有的光澤。\n");
else 
return ("一把神秘而且奇怪的小刀,能夠很隱秘地刺入敵人的心臟而不被發覺，上面有著神秘的黑色光澤。\n");
}
