...
string *attack_msg = ({
        "%s施展黯然銷魂掌中『心驚肉跳』一式，猛然地擊向%s",
        "%s以右手施展黯然銷魂掌中『杞人憂天』一式，向%s一掌擊去",
        "%s以單手施展黯然銷魂掌中『無中生有』一招，向%s猛然擊去",
        "%s將左手負於背，施展黯然銷魂掌中『拖泥帶水』一招，一掌擊向%s",
        "%s施展黯然銷魂掌中『徘□空谷』一招，向%s猛然擊去",
        "%s以右手施展黯然銷魂掌中『力不從心』一式，猛然地擊向%s",
        "%s以單手施展黯然銷魂掌中『行□走肉』一式，向%s一掌擊去",
        "%s將左手負於背，施展黯然銷魂掌中『倒行逆施』一招，向%s猛然擊去",
        "%s施展黯然銷魂掌中『廢寢忘食』一招，一掌擊向%s",
        "%s以右手施展黯然銷魂掌中『孤形隻影』一招，一掌擊向%s",
        "%s以單手施展黯然銷魂掌中『飲恨吞聲』一式，猛然地擊向%s",
        "%s將左手負於背，施展黯然銷魂掌中『六神不安』一式，向%s一掌擊去",
        "%s施展黯然銷魂掌中『窮途末路』一招，向%s猛然擊去",
        "%s以右手施展黯然銷魂掌中『面無人色』一招，一掌擊向%s",
        "%s以單手施展黯然銷魂掌中『想入非非』一式，向%s一掌擊去",
        "%s將左手負於背，施展黯然銷魂掌中『呆若木雞』一式，猛然地擊向%s",
        "%s以右手施展黯然銷魂掌中『魂不守舍』一招，向%s猛然擊去",
});
