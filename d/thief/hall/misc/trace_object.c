...
void create()
{
	...
	set_name("trace object","發報器");
	add( "id", ({ "ob" }) );
	set_short("發報器");
	set_long(
	"這是用來跟蹤某人用的東西, 玩家是看不到的, 請不要隨便 dest 掉。\n"
	);
	set("prevent_drop", 1);
