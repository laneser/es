...
void create ()
{
	...
	set_short( "武將 巫既");
	set_long(@CLONG
巫既長的身材魁偉，孔武有力，濃眉闊頤，一張國字臉剽悍之氣浮現於上。巫既可
謂「巫咸國」裡第一位勇士，兵書陣法無不嫻熟，其人更忠心耿耿，戰場多建功績
，於是倍受城主看重。巫既內和外剛，平時極易和旁人親近，頗得人緣。
CLONG
	);
	set("race","god");
	set("gender","male");
