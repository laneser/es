...
string *attack_msg = ({
"的臉上神情顯得飄逸自豪，以唐詩劍法第一招之「孤鴻海上來、池橫不敢顧」，手上的%s唰的一聲向%s刺去",
"的口中吟著：「下方城郭近、鐘磬雜笙歌」，左手捏了個劍訣，右手握%s向%s直刺過去",
"用%s使出唐詩劍法之「陵寢盤空曲、熊羆守微翠」，青光閃閃，往%s揮了過去",
"大喝一聲：看招，使出「落日照大旗、馬鳴風蕭蕭」，%s發出破空之聲向%s砍去",
"手握%s連抖出片片劍花，使出「俯聽聞驚風、連山若波濤」如狂風暴雨般的往%s連刺數劍"
});
