...
CLong
   ...
   set("exits",([
       "north":Deathland"/dwarf/muse34",
       "south":Deathland"/dwarf/muse32",
       "east":Deathland"/dwarf/muse43",
       "west":Deathland"/dwarf/muse23",
       ]) );
   reset();
}
...
{ 
    write("一座與一般的泉水沒有兩樣的謬思泉, 也許是這個地方給你的感覺, 也許是\n"
          ...
          "這泉水看起來清涼潔淨, 只是它的顏色是一種詭異的藍(blue)色.........\n"
          );
