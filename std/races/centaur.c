...
void setup_race_body()
{
	...
	body->set_c_verbs( ({ "%s突然躍起, 雙腳往%s踹下", "%s用後腿往%s一踢",
		"%s揮拳往%s猛□", "%s雙腳往%s猛踹", }) );
