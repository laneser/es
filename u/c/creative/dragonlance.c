...
void create()
{
        ...
        set_short( "長槍 神龍槍" );
        set_long(
                "這是楊家的傳家之寶,楊六郎視之比性命更為重要\n"
                "據說是這槍中有著可怕的魔法為量,如果你是一個赤膽精忠的人楊家槍就會\n"
                "引發其可怕的魔力,傳說槍中神龍會助你作戰!\n"
        );
        set( "unit", "把" );
        set( "type", "jousting" );
        set( "weapon_class", 49 );
        ...
        if( !holder = environment(this_object()) || !living(holder) ) return 0;
                ...
                if ( random(50) < 10 ) {
                        ...
                        tell_object( holder,set_color(
                                "你手上的","HIW")+C_NAME+set_color("突然飛出空中化成一條銀龍衝向"+him+"。\n","HIW") );
                        tell_object( victim,set_color(
                                me+"手上的","HIW")+C_NAME+set_color("飛到空中化成一第銀龍向你襲來。\n","HIW") );
                        tell_room( environment(holder),set_color(
                                me+"手上的","HIW")+C_NAME+set_color("飛到空中化成一第銀龍衝向"+him+"。\n","HIW"),({ holder,victim }) );
