	...
	string msg, int emote)
{
	...
	if( !who_from || !who_to || !msg )
		return (sndr_chinese ?
			"語法: tell <某人> <訊息>":"Syntax: tell <who> <msg>");

	if( who_to == "" )
		return (sndr_chinese?"你要和誰說話？":"Who do you want to tell?");
