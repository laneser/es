...
int loc;
mixed *schedule = ({
	({ "Bluesand", "藍沙港", "/d/noden/bluesand/jetty", 30, 90 }),
...
void create()
{
	...
	set_short( "Frigate Iriah", "依莉雅號帆船" );
...
{
	return
		"這是一艘叫做依莉雅號的美麗多桅帆船，你如果想要搭乘依莉雅號，可以\n"
		"用 board 指令搭船。\n"
		"依莉雅號的下一個目的地是" + schedule[(loc+1)%sizeof(schedule)][1] + "。\n";
}
...
void announce()
{
	...
	tell_room( ship_room, 
		"依莉雅號的水手大叫: 二十秒後開船！下一站是" + schedule[next_loc][1] + "！\n" );
	tell_room( environment(this_object()), 
		"依莉雅號的水手大叫: 二十秒後開船！下一個目的地是" + schedule[next_loc][1] + "，要上船的旅客請趕快！\n" );
	call_out( "lets_go", 20 );
}
