...
/* pattern 1, psionic attack */
        ...
        "忽然, 你發現自己身在一個火山口旁, 滾燙的岩漿在你四周翻滾著.\n"+
        "塔洛斯的聲音在你腦海中響起: 哈哈哈哈哈... 你的死期到了.\n"+
        "只見一股溶岩打在你身上. 你想要閃躲, 卻發現自己無法動彈.\n":
...
tell_room(environment(this_object()),({
        "你看見"+(string)victim->query("c_name")+"呆呆的站著, 似忽被什麼"+
        "力量控制住了.\n",
...
void ask_gital()
{
    ...
    tell_room(environment(),({
        ...
        "塔洛斯說: Gital? 我之所以留在這裡就是要想辦法把他弄出來.\n"+
        "          誰曉得那魔女太厲害了....\n"+
        "塔洛斯重重的嘆了一口氣.\n"
        }), this_object());
        return;
...
void ask_clue()
{
    ...
    "塔洛斯聳聳肩, 說道: 也好, 你試試吧. 開門法其實很簡單, 照著彩虹\n"+
    "                     的顏色準沒錯.\n"
        }),this_object());
    clue=1;
        return;
...
void help_me(object who)
{
    ...
    "塔洛斯嘆息道: 幫你? 我都自身難保了. 這樣吧, 我這有一個小雕像.\n"+
    "              你帶著, 說不定有用. 它的名字叫 Tio.\n",
        }),this_object());
