...
int do_train(string arg)
{
	...
	if( tmp > 0 ) {
		write("你現在要學此武術，還需要 "+tmp+" 點經驗。\n");
		return 1;
	}

	write( " *** 經過一番苦練，你終於學到了 "+ to_chinese(arg) + " *** \n");
