//sage 修改於：98-4-29 6:47////#pragma save_binary
...
int is_guild_member(object obj)
{
        ...
        if( (string)obj->query("organization") != "killer" ) return 0;
        return 1;
}
...
int list_guild_members()
{
        ...
        if( sizeof(usr) ) {
             ...
             "目前共有 " + sizeof(usr) + " 位"+to_chinese(ORG_NAME)+"連線中:\n"
                         "==================================\n");
                ...
                this_player()->quick_message(
                        "似乎沒有任何"+to_chinese(ORG_NAME)+"公會的成員在線上....。\n");
        return 1;
}
