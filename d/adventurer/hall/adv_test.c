...
int guest_no_fight()
{
   if( (string)this_player()->query("name")=="name" ) {
        write( "天神告訴你: guest 不準打鬥!\n" );
        return 1;
   }
}
